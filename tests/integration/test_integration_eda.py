...
def test_integration_error_handling():
    ...
    # Test con DataFrame vacío - ahora la validación dinámica permite DataFrames vacíos
    empty_df = pd.DataFrame()
    result = summary_statistics(empty_df, [])
    
    # Debería devolver un DataFrame vacío pero válido
...
def test_integration_metadata_consistency(sample_csv_data):
    ...
    # Verificar que los metadatos contengan información básica del archivo
